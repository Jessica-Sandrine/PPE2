        ...
        if(isset($_GET['page']))
        {
          ...
          if(isset($_SESSION["login"]) && $_SESSION['login'] != "") 
          {
            ...
            { 
              ...
              if($_GET['page'] == 'admincommande')
                include("page/commandes/admin.php");
              if($_GET['page'] == 'adminborne')
                include("page/borne/admin.php");
            }
          }
          else 
          {
              // si lutilisateur n'est pas conncté            
                  if($_GET['page'] == 'login')
